...
var app = (function () {
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$1, 11, 8, 349);
    		},
    		m: function mount(target, anchor) {
    ...
    // (7:4) {#if $SettingsStore.activeItem === 'Dashboard'}
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			p = element("p");
    			p.textContent = "Welcome to the dashboard";
    			add_location(p, file$1, 7, 8, 161);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(7:4) {#if $SettingsStore.activeItem === 'Dashboard'}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*$SettingsStore*/ ctx[0].activeItem === "Dashboard") return create_if_block;
    		if (/*$SettingsStore*/ ctx[0].activeItem === "Users") return create_if_block_1;
    		if (/*$SettingsStore*/ ctx[0].activeItem === "Logout") return create_if_block_2;
    	}
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ SettingsStore, $SettingsStore });
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Navigation, Dashboard });
    	return [];
    }
